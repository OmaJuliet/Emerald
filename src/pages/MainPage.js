                ...
                <section className="">
                    <motion.section variants={sectionVariants} initial="hidden" animate="visible" exit="exit" className="container mx-auto flex px-5 py-8 lg:py-12 md:flex-row flex-col items-center">
                        ...
                        <section className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <p className="mb-12 text-left text-base">You get to plan your events and automatically get notified close to your event date.
                        ...
                        <figure className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                            <img className="object-cover object-center rounded" alt="event" src={hero} />
                        </figure>
                    </motion.section>
                </section>
            </section>
            ...
            <section className="text-gray-600 body-font">
                <section className="container px-5 py-24 mx-auto flex flex-wrap">
                    <article className="flex flex-col text-center w-full mb-12">
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Events</h1>
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Make plans for future events; birthdays, graduation, conferences, parties and lots more.</p>
                    </article>
                    <aside className="flex flex-wrap md:-m-2 -m-1">
                        <figure className="flex flex-wrap w-1/2">
                            <figure className="md:p-2 p-1 w-full">
                                <img alt="gallery" className="w-full h-full object-cover object-center block" src={event4} />
                            </figure>
                            <figure className="md:p-2 p-1 w-1/2">
                                <img alt="gallery" className="w-full object-cover h-full object-center block" src={event5} />
                            </figure>
                            <figure className="md:p-2 p-1 w-1/2">
                                <img alt="gallery" className="w-full object-cover h-full object-center block" src={event6} />
                            </figure>
                        </figure>
                        <figure className="flex flex-wrap w-1/2">
                            <figure className="md:p-2 p-1 w-1/2">
                                <img alt="gallery" className="w-full object-cover h-full object-center block" src={event1} />
                            </figure>
                            <figure className="md:p-2 p-1 w-1/2">
                                <img alt="gallery" className="w-full object-cover h-full object-center block" src={event2} />
                            </figure>
                            <figure className="md:p-2 p-1 w-full">
                                <img alt="gallery" className="w-full h-full object-cover object-center block" src={event3} />
                            </figure>
                        </figure>
                    </aside>
                </section>
            ...
            <section>
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap -m-4 text-center">
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div animate={{ boxShadow: "0px 0px 8px rgba(99 102 241)" }} className="px-4 py-6 rounded-lg">
                            ...
                            <article className="p-4 md:w-1/2 w-full">
                                <figure className="h-full bg-gray-100 p-6 text-left rounded">
                                    <aside className="flex flex-row lg:items-left">
                                        <img src={testimonial.image} className="w-16 h-16 rounded-full flex-shrink-0 object-cover object-center" alt="face" />
                                        <span className="flex-grow flex flex-col pl-4">
                                            <span className="text-lg font-medium text-gray-900">{testimonial.name}</span>
                                            <span className="flex flex-row text-orange-500 my-1">{testimonial.icons}{testimonial.icons}{testimonial.icons}{testimonial.icons}{testimonial.icons}</span>
                                            <span className="text-gray-700 text-base">{testimonial.location}</span>
                                        </span>
                                    </aside>
                                    <p className="leading-relaxed mb-2 mt-2 text-left">{testimonial.text}</p>
                                </figure>
                            </article>
                        ))}
                    </article>
